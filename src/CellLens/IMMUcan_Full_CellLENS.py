...
parser = argparse.ArgumentParser(description='Running CellLENS on Immucan.')
...
def pad_image(image, target_shape=(1000, 1000)):
...
#example usage: python3 IMMUcan_Full_CellLENS.py -i ../../Maps_data/cHL_2_MIBI/quantification/processed/cHL_2_MIBI_quantification.csv -pi ../../Maps_data/cHL_2_MIBI/raw_image/max_projections -pc ../chl2/processed_images -o ../cHL2/ -m CD163 CD11c CD28 -l long -it 1
#immucan markers:
