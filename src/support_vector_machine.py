...
class MultiClassLinearSVC:
    def __init__(self,
        ...
        if multi_class not in ['ovr', 'crammer_singer']:
            raise ValueError("Multi_class must be 'ovr' or 'crammer_singer'.")
        
        self.random_state = random_state
        self.data_handler = None
        self.model = svc(penalty=penalty,
                         loss=loss,
                         dual=dual,
                         tol=tol,
                         C=C,
        ...
        print('MultiClassSVM class initialized successfully with the following parameters:')
        ...
        print(f'  intercept_scaling: {intercept_scaling}')
