...
def load_image(image_path, cells_path, cells2labels_path, channels=[], channel_indices=None, to_pad=False, crop_size=0):
...
def load_samples(images_dir, cells_dir, cells2labels_dir, images_names, crop_size, to_pad=False, channels=None, channel_indices=None):
    """
...
def load_crops(root_dir,
    ...
    cells2labels_dir = cell_types_dir / "cells2labels" / cell_type_col
    ...
    train_crops = load_samples(images_dir=data_dir, cells_dir=cells_dir, cells2labels_dir=cells2labels_dir,
                               ...
                               channels=channels, channel_indices=channel_indices)
