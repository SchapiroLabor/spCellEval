...
parser.add_argument('-o', '--output', dest='output_path', type = str, help='Path to output folder, usually ends with dataset name/nimbus.')
...
#example usage: python3 nimbus.py -i /Volumes/Gut_Project/pheno_benchmark/Maps_data/cHL_2_MIBI/raw_image -o /Users/margotchazotte/Documents/uni/PhD/pheno_benchmark/nimbus/nimbus_test -s /Volumes/Gut_Project/pheno_benchmark/Maps_data/cHL_2_MIBI/segmentation/masks -m CD163 CD11c CD28 -l long --mask_type tif -it 1
